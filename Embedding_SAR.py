...
with open(file_path, 'r', encoding='utf-8') as f:
    ...
    for line in tqdm(f, total=total_lines, desc="Processing Japanese Data"):
        ...
        full_text = (
            ...
            f"Summary: {item['summarize_content']}\n"
            f"Questions: {' '.join(item['related_questions'])}"
        )
        ...
        for chunk in chunk_text(full_text):
            try:
                ...
                metadata_store.append({
                    ...
                    "summary": item['summarize_content'],
...
# Save results
np.save('jp_vectors.npy', np.array(all_embeddings))
with open('jp_metadata.json', 'w', encoding='utf-8') as f:
